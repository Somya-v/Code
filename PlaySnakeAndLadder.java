...
public class PlaySnakeAndLadder {
	public static void main(String[] args) {
		...
		Player p1 = new Player("somya", 1);
		Player p2 = new Player("anya", 2);
		...
		snakes.add(snake1);
		snakes.add(snake2);
		Jumper ladder1 = new Jumper(25, 78);
		Jumper ladder2 = new Jumper(50, 90);
		List<Jumper> ladders = new ArrayList<>();
		ladders.add(ladder1);
		ladders.add(ladder2);
		Map<String, Integer> playersCurrentPosition = new HashMap<>();
		playersCurrentPosition.put("somya", 0);
		playersCurrentPosition.put("anya", 0);
